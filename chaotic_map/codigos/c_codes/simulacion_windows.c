...
long long multTrunc( long long x, long long y ){		// Multiplicacion con truncamiento
	...
	b = y;
	r = a*b;
	printf("h = %16.16llx, l = %16.16llx ",(long long)(r >> 64), (long long)r);
	r = r >> _b;
	printf("left = %16.16llx, right = %16.16llx",(long long)(r >> 64), (long long)r );
...
int main(int argc, char *argv[]){
	...
	// Archivo de texto
  	FILE *fpointer = fopen("salida1.txt","w");
